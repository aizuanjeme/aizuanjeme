...
## About Me
I am a full-stack web developer, passionate about all things web and open-source. Highly adept in Javascript, writing modular, scalable, and efficient code that works both on the browser and on the server, making modern web applications work as they should: beautiful, efficient, fast, and easy to use. Experienced in using Javascript ES6+, React, Redux, NodeJS, and NestJS in a single unified workflow, with a passion for tooling and workflow automation.
